...
interface IWindow extends EventTarget, WindowTimers, WindowSessionStorage, WindowLocalStorage, WindowConsole, GlobalEventHandlers, IDBEnvironment, WindowBase64, GlobalFetch {
  ...
  onabort: (this: IWindow, ev: UIEvent) => any;
  onafterprint: (this: IWindow, ev: Event) => any;
  onbeforeprint: (this: IWindow, ev: Event) => any;
  onbeforeunload: (this: IWindow, ev: BeforeUnloadEvent) => any;
  onblur: (this: IWindow, ev: FocusEvent) => any;
  oncanplay: (this: IWindow, ev: Event) => any;
  oncanplaythrough: (this: IWindow, ev: Event) => any;
  onchange: (this: IWindow, ev: Event) => any;
  onclick: (this: IWindow, ev: MouseEvent) => any;
  oncompassneedscalibration: (this: IWindow, ev: Event) => any;
  oncontextmenu: (this: IWindow, ev: PointerEvent) => any;
  ondblclick: (this: IWindow, ev: MouseEvent) => any;
  ondevicelight: (this: IWindow, ev: DeviceLightEvent) => any;
  ondevicemotion: (this: IWindow, ev: DeviceMotionEvent) => any;
  ondeviceorientation: (this: IWindow, ev: DeviceOrientationEvent) => any;
  ondrag: (this: IWindow, ev: DragEvent) => any;
  ondragend: (this: IWindow, ev: DragEvent) => any;
  ondragenter: (this: IWindow, ev: DragEvent) => any;
  ondragleave: (this: IWindow, ev: DragEvent) => any;
  ondragover: (this: IWindow, ev: DragEvent) => any;
  ondragstart: (this: IWindow, ev: DragEvent) => any;
  ondrop: (this: IWindow, ev: DragEvent) => any;
  ondurationchange: (this: IWindow, ev: Event) => any;
  onemptied: (this: IWindow, ev: Event) => any;
  onended: (this: IWindow, ev: MediaStreamErrorEvent) => any;
  onerror: ErrorEventHandler;
  onfocus: (this: IWindow, ev: FocusEvent) => any;
  onhashchange: (this: IWindow, ev: HashChangeEvent) => any;
  oninput: (this: IWindow, ev: Event) => any;
  oninvalid: (this: IWindow, ev: Event) => any;
  onkeydown: (this: IWindow, ev: KeyboardEvent) => any;
  onkeypress: (this: IWindow, ev: KeyboardEvent) => any;
  onkeyup: (this: IWindow, ev: KeyboardEvent) => any;
  onload: (this: IWindow, ev: Event) => any;
  onloadeddata: (this: IWindow, ev: Event) => any;
  onloadedmetadata: (this: IWindow, ev: Event) => any;
  onloadstart: (this: IWindow, ev: Event) => any;
  onmessage: (this: IWindow, ev: MessageEvent) => any;
  onmousedown: (this: IWindow, ev: MouseEvent) => any;
  onmouseenter: (this: IWindow, ev: MouseEvent) => any;
  onmouseleave: (this: IWindow, ev: MouseEvent) => any;
  onmousemove: (this: IWindow, ev: MouseEvent) => any;
  onmouseout: (this: IWindow, ev: MouseEvent) => any;
  onmouseover: (this: IWindow, ev: MouseEvent) => any;
  onmouseup: (this: IWindow, ev: MouseEvent) => any;
  onmousewheel: (this: IWindow, ev: WheelEvent) => any;
  onmsgesturechange: (this: IWindow, ev: MSGestureEvent) => any;
  onmsgesturedoubletap: (this: IWindow, ev: MSGestureEvent) => any;
  onmsgestureend: (this: IWindow, ev: MSGestureEvent) => any;
  onmsgesturehold: (this: IWindow, ev: MSGestureEvent) => any;
  onmsgesturestart: (this: IWindow, ev: MSGestureEvent) => any;
  onmsgesturetap: (this: IWindow, ev: MSGestureEvent) => any;
  onmsinertiastart: (this: IWindow, ev: MSGestureEvent) => any;
  onmspointercancel: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerdown: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerenter: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerleave: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointermove: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerout: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerover: (this: IWindow, ev: MSPointerEvent) => any;
  onmspointerup: (this: IWindow, ev: MSPointerEvent) => any;
  onoffline: (this: IWindow, ev: Event) => any;
  ononline: (this: IWindow, ev: Event) => any;
  onorientationchange: (this: IWindow, ev: Event) => any;
  onpagehide: (this: IWindow, ev: PageTransitionEvent) => any;
  onpageshow: (this: IWindow, ev: PageTransitionEvent) => any;
  onpause: (this: IWindow, ev: Event) => any;
  onplay: (this: IWindow, ev: Event) => any;
  onplaying: (this: IWindow, ev: Event) => any;
  onpopstate: (this: IWindow, ev: PopStateEvent) => any;
  onprogress: (this: IWindow, ev: ProgressEvent) => any;
  onratechange: (this: IWindow, ev: Event) => any;
  onreadystatechange: (this: IWindow, ev: ProgressEvent) => any;
  onreset: (this: IWindow, ev: Event) => any;
  onresize: (this: IWindow, ev: UIEvent) => any;
  onscroll: (this: IWindow, ev: UIEvent) => any;
  onseeked: (this: IWindow, ev: Event) => any;
  onseeking: (this: IWindow, ev: Event) => any;
  onselect: (this: IWindow, ev: UIEvent) => any;
  onstalled: (this: IWindow, ev: Event) => any;
  onstorage: (this: IWindow, ev: StorageEvent) => any;
  onsubmit: (this: IWindow, ev: Event) => any;
  onsuspend: (this: IWindow, ev: Event) => any;
  ontimeupdate: (this: IWindow, ev: Event) => any;
  ontouchcancel: (ev: TouchEvent) => any;
  ontouchend: (ev: TouchEvent) => any;
  ontouchmove: (ev: TouchEvent) => any;
  ontouchstart: (ev: TouchEvent) => any;
  onunload: (this: IWindow, ev: Event) => any;
  onvolumechange: (this: IWindow, ev: Event) => any;
  onwaiting: (this: IWindow, ev: Event) => any;
  opener: any;
